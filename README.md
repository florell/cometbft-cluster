`tendermint-cluster` — минимальный пример кластера на основе [CometBFT](https://cometbft.com/) с интеграцией собственного ABCI-приложения для управления версионируемыми конфигами. Приложение разворачивается в Kubernetes с помощью Minikube и автоматизированных скриптов.

---

## Структура

- **main.go** — простое ABCI-приложение на Go, позволяющее публиковать новые версии конфигов и откатываться к предыдущим.
